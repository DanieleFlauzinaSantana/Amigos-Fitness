...
const SendAbsenceNotificationInputSchema = z.object({
  ...
  gymName: z.string().describe('O nome da academia a ser usado na mensagem (virá das configurações).'),
...
const prompt = ai.definePrompt({
  ...
  prompt: `Você é um assistente de IA amigável e atencioso da academia {{{gymName}}}. Seu objetivo é criar mensagens SMS personalizadas e acolhedoras em PORTUGUÊS para alunos que têm faltado.
...
Nome da Academia a ser usado na mensagem: {{{gymName}}}
...
- Mencione que sentimos falta dele(a) na academia {{{gymName}}}.
