...
import { LayoutDashboard, Users, FileText, ClipboardCheckIcon, TrendingDown, BrainCircuit } from 'lucide-react'; // Ícone adicionado
...
export const anaSilvaSurveyResponse: SurveyResponse = {
  ...
  answers: [
    ...
    { questionId: 'q3_comments', value: 'Adoraria mais opções de aulas de dança no período da noite e talvez alguns equipamentos de cardio mais modernos.' },
    { questionId: 'q4_cleanliness', value: 5 },
    { questionId: 'q5_equipment_quality', value: 4 },
    { questionId: 'q6_equipment_availability', value: "Geralmente disponíveis" },
    { questionId: 'q7_instructors_availability', value: "Satisfeito(a)" },
    { questionId: 'q8_instructors_quality', value: 5 },
    { questionId: 'q9_class_schedule', value: "Poderia ser melhor" },
...
export const MOCK_STUDENTS: Student[] = [
  {
    ...
    attendance: [
      ...
      { date: '2024-07-26', attended: false },
    ],
